...
describe('CartService', () => {
  ...
  const expected = plainToClass(CartEntity, {
  ...
  describe('createOne', () => {
    it('should be return cart-element entity', async () => {
      const received = await service.createOne({ ...expected });
      expect(received).toBeInstanceOf(CartEntity);
  ...
  describe('selectAll', () => {
    it('should be return cart-element entity', async () => {
      ...
      expect(received).toBeInstanceOf(PaginationCartItemsDto);
    });
